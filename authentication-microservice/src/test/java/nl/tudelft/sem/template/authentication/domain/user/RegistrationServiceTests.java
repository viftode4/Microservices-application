...
public class RegistrationServiceTests {
    ...
    //test registerCandidate
    @Test
    public void registerCandidate_withValidData_worksCorrectly() throws Exception {
        // Arrange
        final NetId testUser = new NetId("SomeUser");
        final Password testPassword = new Password("password123");
        final HashedPassword testHashedPassword = new HashedPassword("hashedTestPassword");
        ...
        // Act
        registrationService.registerCandidate(testUser, testPassword);
    ...
    //test setHr
    @Test
    public void setHr_withValidData_worksCorrectly() throws Exception {
        // Arrange
        final NetId testUser = new NetId("SomeUser");
        final Password testPassword = new Password("password123");
        final HashedPassword testHashedPassword = new HashedPassword("hashedTestPassword");
        ...
        // Act
        registrationService.registerUser(testUser, testPassword);
        registrationService.setHr(testUser);
        ...
        assertThat(savedUser.getNetId()).isEqualTo(testUser);
        assertThat(savedUser.getPassword()).isEqualTo(testHashedPassword);
        assertThat(savedUser.getRole()).isEqualTo(Role.HR);
    }
